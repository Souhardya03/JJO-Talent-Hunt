...
import { CheckCircle2, Copy, Home, Mail, User, CreditCard, DollarSign } from "lucide-react";
        ...
        <div className="min-h-screen bg-[#f8fafc] py-12 px-4 mt-14 sm:px-6 font-sans text-slate-900 flex items-center justify-center">
            <div className="max-w-xl w-full space-y-6">
                <Card className="rounded-2xl border-none shadow-xl overflow-hidden">
                    <div className="bg-emerald-500 p-8 text-center space-y-4">
                        ...
                        <p className="text-emerald-100 font-medium text-sm">Your registration has been confirmed and recorded.</p>
                    </div>
